...
## Gemini Studio models

https://ai.google.dev/gemini-api/docs/models

## text-to-text only (recommended)
...
## legacy text-to-text (deprecated)
- gemini-2.0-flash
...
## AI providers: possible cases and requirements
...
#### ICT Query AI (V2) — `transforms/getAIV2.py`
Main logs:
- Type of `request.Properties`.
- Full dump of `Properties` + `TransformSettings`.
Note: does not log AI response or call parameters.

#### ICT Query AI (legacy) — `transforms/getAI.py`
Main logs:
- Type of `request.Properties`.
- Full dump of `Properties` + `TransformSettings`.
Note: does not log AI response or call parameters.
...
## getAIV3: providers, parameters and fallback (full explanation)
