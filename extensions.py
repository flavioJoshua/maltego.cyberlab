...
registry = TransformRegistry(
    owner="Italian Cyber Team ",
    author="Flavio Critelli <flavio.critelli@italiancyberteam.it>",
    host_url="https://italiancyberteam.it",
    seed_ids=["demo"],
)
...
registry.display_name_suffix = " ICT Label"
